          ...
          <section className="w-11/12  h-full">
            <form action="" className=" p-4 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 place-items-center gap-4">
                <input
                  className="bg-gray-200 shadow-sm px-3 placeholder:font-normal  ld font-medium border-b-2 border-green-500 box-border border-opacity-0 hover:border-opacity-100 transition-all duration-[0.4s] py-2 w-full outline-none"
                  type="text"
                  placeholder="Name"
                />
                <input
              ...
              <textarea
                className="bg-gray-200 shadow-sm px-3 placeholder:font-normal  ld font-medium border-b-2 border-green-500 box-border border-opacity-0 hover:border-opacity-100 transition-all py-2 w-full outline-none h-[12rem]  resize-y"
                placeholder="Message"
              ></textarea>
