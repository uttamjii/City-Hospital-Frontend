...
import { updateUserRoleAndAdminRole } from "../../../../Actions/adminUsersActions";
...
const UpdateUserRole = () => {
  ...
  const [buttonText, setButtonText] = useState("Update Role");

  const optionsRef = useRef();
  const [optionValue, setOptionValue] = useState(
    role === "Admin" || role === "User" ? role : "Choose User Role"
  );
  ...
  const formSubmitHandler = (e) => {
    ...
    dispatch(updateUserRoleAndAdminRole(id, optionValue));
  };
  ...
  }, [dispatch, message, asUserError, loading]);
          ...
          <form className=" space-y-4" onSubmit={formSubmitHandler}>
            ...
            <section className="relative ">
              ...
              <section
                ...
                onClick={optionsHandler}
              >
                <h1 className=" p-1">User</h1>
                <h1 className=" p-1">Admin</h1>
              </section>
            </section>
